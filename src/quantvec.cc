...
namespace casacore { namespace python {
  ...
  void quantvec()
  {
    boost::python::class_<QProxy> ("QuantVec")
      .def (boost::python::init< >())
      .def (boost::python::init< const QProxy& > ())
      .def (boost::python::init< const VD&, const String& >())
      ...
      .def (boost::python::self -= boost::python::self)
      .def (boost::python::self -= VD())
      .def (boost::python::self - VD() )
      .def (VD() - boost::python::self)
      .def (+boost::python::self)
      .def (boost::python::self + boost::python::self)
      .def (boost::python::self += boost::python::self)
      .def (boost::python::self += VD())
      ...
      ;
    boost::python::def ("from_dict_v", &qpfromRecord);
